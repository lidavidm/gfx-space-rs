...
void main() {
  vec2 uv0 = v_Uv + vec2(-0.0025, -0.0025);
  vec2 uv1 = v_Uv + vec2(0, -0.0025);
  vec2 uv2 = v_Uv + vec2(0.0025, -0.0025);
  vec2 uv3 = v_Uv + vec2(-0.0025, 0);
  vec2 uv4 = v_Uv + vec2(0, 0);
  vec2 uv5 = v_Uv + vec2(0.0025, 0);
  vec2 uv6 = v_Uv + vec2(-0.0025, 0.0025);
  vec2 uv7 = v_Uv + vec2(0, 0.0025);
  vec2 uv8 = v_Uv + vec2(0.0025, 0.0025);
